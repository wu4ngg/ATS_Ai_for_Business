...
def get_datetime_type(help=None, date=True, time=True, timezone=True):
    ...
    class DatetimeAction(argparse.Action):
        ...
        def __call__(self, parser, namespace, values, option_string=None):
            ...
            if not dt_val:
                raise AzureMLException("Unable to parse: '{}'. Expected format: {}".format(value_string, help_string))
...
def get_one_of_subscription_locations(cli_ctx):
    ...
    raise AzureMLException('Current subscription does not have valid location list')
...
def get_enum_type(data, default=None):
    ...
    if default:
        ...
        if not default_value:
            raise AzureMLException("Command authoring exception: unrecognized default '{}' from "
                                   "choices '{}'".format(default, choices))
