...
def resolve_client_arg_name(operation, kwargs):
    if not isinstance(operation, str):
        raise AzureMLException("operation should be type 'str'. Got '{}'".format(type(operation)))
...
def get_data_service_client(cli_ctx, service_type, account_name, account_key, connection_string=None,
    ...
    try:
        ...
        raise AzureMLException('Unable to obtain data client. Check your connection parameters.')
    # TODO: enable Fiddler
