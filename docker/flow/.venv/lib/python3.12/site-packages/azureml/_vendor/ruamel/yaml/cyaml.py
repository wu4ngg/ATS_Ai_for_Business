...
from azureml._vendor.ruamel._ruamel_yaml import CParser, CEmitter  # type: ignore

from azureml._vendor.ruamel.yaml.constructor import Constructor, BaseConstructor, SafeConstructor
from azureml._vendor.ruamel.yaml.representer import Representer, SafeRepresenter, BaseRepresenter
from azureml._vendor.ruamel.yaml.resolver import Resolver, BaseResolver

if False:  # MYPY
    from typing import Any, Union, Optional  # NOQA
    from azureml._vendor.ruamel.yaml.compat import StreamTextType, StreamType, VersionType  # NOQA
