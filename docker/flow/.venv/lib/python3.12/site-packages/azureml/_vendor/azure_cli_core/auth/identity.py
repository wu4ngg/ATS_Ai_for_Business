    ...
    def __init__(self, entry):
        ...
        if _CERTIFICATE in entry:
            ...
            try:
                ...
                raise AzureMLException('Invalid certificate, please use a valid PEM file. Error detail: {}'.format(ex))
...
class ServicePrincipalStore:
    ...
    def load_entry(self, sp_id, tenant):
        ...
        if not matched:
            raise AzureMLException("Could not retrieve credential from local cache for service principal {}. "
                                   "Run `az login` for this service principal.".format(sp_id))
