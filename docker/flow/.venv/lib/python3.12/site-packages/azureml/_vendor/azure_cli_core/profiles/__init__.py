...
from azureml._vendor.azure_cli_core.profiles._shared import AZURE_API_PROFILES, ResourceType, CustomResourceType, PROFILE_TYPE,\
...
def supported_resource_type(cli_ctx, resource_type):
    from azureml._vendor.azure_cli_core.profiles._shared import supported_resource_type as _supported_resource_type
