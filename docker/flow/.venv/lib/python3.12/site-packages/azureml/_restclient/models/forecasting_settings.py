...
class ForecastingSettings(Model):
    ...
    :param target_lags:
    :type target_lags: ~_restclient.models.TargetLags
    ...
    def __init__(self, forecasting_country_or_region=None, time_column_name=None, target_lags=None, target_rolling_window_size=None, forecast_horizon=None, time_series_id_column_names=None):
        super(ForecastingSettings, self).__init__()
