...
class AKSServiceResponseLivenessProbeRequirements(LivenessProbeRequirements):
    ...
    def __init__(self, failure_threshold=None, success_threshold=None, timeout_seconds=None, period_seconds=None, initial_delay_seconds=None):
        super(AKSServiceResponseLivenessProbeRequirements, self).__init__(failure_threshold=failure_threshold, success_threshold=success_threshold, timeout_seconds=timeout_seconds, period_seconds=period_seconds, initial_delay_seconds=initial_delay_seconds)
