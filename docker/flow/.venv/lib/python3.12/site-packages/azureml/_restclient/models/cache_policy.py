...
class CachePolicy(Model):
    ...
    def __init__(self, ttl=None, high_water_mark=None, low_water_mark=None, total_capacity_in_gb=None, default_replica_number=None, data_management_compute_name=None, singularity_settings=None, data_hydration_external_resources=None):
