...
class AKSServiceCreateRequestContainerResourceRequirements(ContainerResourceRequirements):
    ...
    def __init__(self, cpu=None, memory_in_gb=None, gpu=None, fpga=None):
        super(AKSServiceCreateRequestContainerResourceRequirements, self).__init__(cpu=cpu, memory_in_gb=memory_in_gb, gpu=gpu, fpga=fpga)
