...
class MirServiceResponseEnvironmentImageRequest(EnvironmentImageRequest):
    ...
    def __init__(self, driver_program=None, assets=None, model_ids=None, models_property=None, environment=None, environment_reference=None):
        super(MirServiceResponseEnvironmentImageRequest, self).__init__(driver_program=driver_program, assets=assets, model_ids=model_ids, models_property=models_property, environment=environment, environment_reference=environment_reference)
