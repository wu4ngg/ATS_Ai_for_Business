...
class MetricDto(Model):
    ...
    def __init__(self, metric_id=None, metric_type=None, created_utc=None, name=None, description=None, label=None, num_cells=None, data_location=None, cells=None, schema=None):
        super(MetricDto, self).__init__()
