...
# fmt: off
from azureml._vendor.ruamel.yaml.error import (
    MarkedYAMLError, MarkedYAMLFutureWarning,
    MantissaNoDotYAML1_1Warning
)
from azureml._vendor.ruamel.yaml.nodes import *                               # NOQA
from azureml._vendor.ruamel.yaml.nodes import (SequenceNode, MappingNode, ScalarNode)
from azureml._vendor.ruamel.yaml.compat import (_F, builtins_module, # NOQA
                                nprint, nprintf, version_tnf)
from azureml._vendor.ruamel.yaml.compat import ordereddict

from azureml._vendor.ruamel.yaml.comments import *  # NOQA
from azureml._vendor.ruamel.yaml.comments import (
...
from azureml._vendor.ruamel.yaml.scalarstring import (
    SingleQuotedScalarString, DoubleQuotedScalarString,
    LiteralScalarString, FoldedScalarString,
    PlainScalarString, ScalarString,
)
from azureml._vendor.ruamel.yaml.scalarint import ScalarInt, BinaryInt, OctalInt, HexInt, HexCapsInt
from azureml._vendor.ruamel.yaml.scalarfloat import ScalarFloat
from azureml._vendor.ruamel.yaml.scalarbool import ScalarBoolean
from azureml._vendor.ruamel.yaml.timestamp import TimeStamp
from azureml._vendor.ruamel.yaml.util import RegExp
...
class RoundTripConstructor(SafeConstructor):
    ...
    def construct_rt_sequence(self, node, seqtyp, deep=False):
        ...
        if node.anchor:
            from azureml._vendor.ruamel.yaml.serializer import templated_id
    ...
    def construct_yaml_object(self, node, cls):
        ...
        if node.anchor:
            from azureml._vendor.ruamel.yaml.serializer import templated_id
            from azureml._vendor.ruamel.yaml.anchor import Anchor
