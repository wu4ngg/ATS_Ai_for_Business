...
import sys
from azureml._vendor.ruamel.yaml.error import YAMLError, YAMLStreamError
from azureml._vendor.ruamel.yaml.events import *  # NOQA

# fmt: off
from azureml._vendor.ruamel.yaml.compat import _F, nprint, dbg, DBG_EVENT, \
    check_anchorname_char, nprintf  # NOQA
# fmt: on

if False:  # MYPY
    from typing import Any, Dict, List, Union, Text, Tuple, Optional  # NOQA
    from azureml._vendor.ruamel.yaml.compat import StreamType  # NOQA
