...
from azureml._vendor.ruamel.yaml.compat import MutableSliceableSequence, _F, nprintf  # NOQA
from azureml._vendor.ruamel.yaml.scalarstring import ScalarString
...
class CommentedBase:
    ...
    def yaml_set_comment_before_after_key(
        ...
        """
        from azureml._vendor.ruamel.yaml.error import CommentMark
        from azureml._vendor.ruamel.yaml.tokens import CommentToken
