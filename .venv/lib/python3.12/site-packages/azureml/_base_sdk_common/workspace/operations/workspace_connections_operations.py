...
class WorkspaceConnectionsOperations(object):
    ...
    def list(
        ...
        if target is not None:
            query_parameters['target'] = self._serialize.query(
                "target", target, 'str')
    ...
    list.metadata = {
        'url': (
            ...
            '/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections')}
    ...
    def create(
        ...
        path_format_arguments = {
            ...
            'workspaceName': self._serialize.url(
                ...
                workspace_name,
                'str'),
            'connectionName': self._serialize.url(
                "connection_name",
                connection_name,
                'str')}
        url = self._client.format_url(url, **path_format_arguments)
    ...
    create.metadata = {
        'url': (
            ...
            '/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/connections/{connectionName}')}
