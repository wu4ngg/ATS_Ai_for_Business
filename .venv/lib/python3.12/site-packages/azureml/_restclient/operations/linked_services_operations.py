...
class LinkedServicesOperations(object):
    ...
    def create(
            self, subscription_id, resource_group_name, workspace_name, link_name, parameters, custom_headers=None, raw=False, **operation_config):
    ...
    def get(
            self, subscription_id, resource_group_name, workspace_name, link_name, custom_headers=None, raw=False, **operation_config):
