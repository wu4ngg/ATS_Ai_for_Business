...
class EnvironmentDefinition(Model):
    ...
    :type python: ~_restclient.models.PythonSection
    ...
    :type docker: ~_restclient.models.DockerSection
    :param spark: The configuration for a Spark environment.
    :type spark: ~_restclient.models.SparkSection
    :param r: Settings for a R environment.
    :type r: ~_restclient.models.RSection
