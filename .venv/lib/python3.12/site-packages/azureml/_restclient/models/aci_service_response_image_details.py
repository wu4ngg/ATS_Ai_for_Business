...
class ACIServiceResponseImageDetails(DockerImageResponse):
    """The Image details.
    ...
    def __init__(self, id=None, name=None, version=None, digest=None, description=None, kv_tags=None, properties=None, created_time=None, modified_time=None, auto_delete=None, image_type=None, creation_state=None, error=None, model_ids=None, model_details=None, image_location=None, image_build_log_uri=None, operation_id=None, driver_program=None, assets=None, target_runtime=None, docker_file_uri=None, generated_docker_file_uri=None):
        super(ACIServiceResponseImageDetails, self).__init__(id=id, name=name, version=version, digest=digest, description=description, kv_tags=kv_tags, properties=properties, created_time=created_time, modified_time=modified_time, auto_delete=auto_delete, image_type=image_type, creation_state=creation_state, error=error, model_ids=model_ids, model_details=model_details, image_location=image_location, image_build_log_uri=image_build_log_uri, operation_id=operation_id, driver_program=driver_program, assets=assets, target_runtime=target_runtime, docker_file_uri=docker_file_uri, generated_docker_file_uri=generated_docker_file_uri)
        self.image_flavor = 'ACIServiceResponse_imageDetails'
