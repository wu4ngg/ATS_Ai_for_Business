...
class WorkspaceUpdateParameters(Model):
    ...
    _attribute_map = {
        ...
        'v1_legacy_mode': {'key': 'properties.v1LegacyMode', 'type': 'str'},
    }

    def __init__(self, tags=None, sku=None, identity=None, description=None, friendly_name=None, service_managed_resources_settings=None, image_build_compute=None, allow_public_access_when_behind_vnet=None, primary_user_assigned_identity=None, v1_legacy_mode=None):
