...
class TensorflowOptimizationConfig(OptimizationConfig):
    """The TensorFlow optimization configuration.
    ...
    :type framework: str
    :param signature_def_name: The signature definition name. Please see
     https://www.tensorflow.org/tfx/serving/signature_defs for more
     information.
    :type signature_def_name: str
    """
    ...
    _attribute_map = {
        ...
        'signature_def_name': {'key': 'signatureDefName', 'type': 'str'},
    }

    def __init__(self, onnx_tuning_enabled, inputs_schema=None, outputs_schema=None, model_path=None, sample_input_data=None, signature_def_name=None):
        super(TensorflowOptimizationConfig, self).__init__(inputs_schema=inputs_schema, outputs_schema=outputs_schema, onnx_tuning_enabled=onnx_tuning_enabled, model_path=model_path, sample_input_data=sample_input_data)
        self.signature_def_name = signature_def_name
